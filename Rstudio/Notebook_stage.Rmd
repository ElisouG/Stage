...
<p style="text-align:justify";>Je pense que je vais me faire une fiche en RMD pour tout ce qui est GATK et j'y ajouterait le choix des filtres. Ou alors je détaille plus GATK et je me fais une fiche à part pour les filtres. Je pense que la deuxième option est la meilleure. C'est celle que je vais choisir pour ne pas faire du doucle emploi quoi que, une page script et leur détail peut être utile.</p>
