...
<p style="text-align:justify";>Sur le forum de GATK ils ont répondu. En fait il suffit de mentionner les fichiers RefIndex et RefDict dans la tâche et dans le call même si l'outils ne l'appelle pas car il va l'utiliser quand même. Je suis en train de tester ce qu'ils m'ont dit. J'espère que ça va marcher.</p>
...
<p style="text-align:justify";>Ce matin j'ai lu 3 papiers sur les statistics des SNPs à savoir des test d'association de variant et des tests d'association d'haplotype.</p>

<p style="text-align:justify";>J'ai essayé de configurer une connection VPN sur l'ordi ubuntu de Flo mais ça ne fonctionne pas car il y a un problème avec des packages R. J'imagine qu'ils ne sont pas à jour. On va voir ça ce soir avec Flo.</p>
