...
<p style="text-align:justify";>Data_PreProcessing a fonctionné. C'est trop cool. Je suis en train de le relancer avec mon script R dans le PATH, j'aimerais bien que ça fonctionne. Je l'ai lancé sans avoir installé les packages nécessaires du coup je les installe. J'espère que ce n'est pas trop tard. Je pense que du coup ça n'a pas été pris en compte car il me dit qu'il ne trouve pas les packages que j'ai installé. Du coup, j'ai ajouté le chemin de la librairy pour qu'il les trouve. au cas où ça ne fonctionnerait pas j'ai ajouté -l DEBUG et je lancerait le script manuellement. Et d'autre part je transfert les données obtenues sur mon ordi. Pour pouvoir ensuite les transférer sur TYCHO. Mais je sens que ça va prendre du temps car le dossier fait dans les 800Go. Oui oui autant !!!!</p>
