...
<p style="text-align:justify";>J'ai regardé les fichiers produits ce matin avec les modifications d'hier. J'ai découvert que pour les brin sens tout se passe pour le mieux. Par contre concernant le brin antisens cela ne se passe pas de la même manière. En effet, il y a un décalage de 1 par rapport au fasta. Il faut donc que je récrive un fichier GTF avec les modifications pour les brins antisens uniquement ^^.</p>
...
TopHat est un algner de reads qui réalise aussi des analyses de "splice-jonction".</p>
